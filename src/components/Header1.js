...
const Header1 = ({
  ...
  onNoticeTextClick,
  onFAQTextClick,
  onMasterSecondaryButtonClick,
  onMasterPrimaryButtonClick,
}) => {
  return (
    <header
      className={`self-stretch bg-grayscale-white flex flex-row items-end justify-between pt-[32.1px] pb-[31.9px] pr-[110px] pl-20 box-border top-[0] z-[99] sticky max-w-full gap-[20px] text-left text-3xl-7 text-mediumslateblue-100 font-ubuntu mq450:pr-5 mq450:box-border mq800:pl-10 mq800:pr-[55px] mq800:box-border ${className}`}

    >
      <div className="h-[117.9px] w-[1440px] relative bg-grayscale-white hidden max-w-full" />
      ...
      <div className="w-[480px] flex flex-row items-start justify-start gap-[24px] max-w-full mq800:w-[162px]">
        <nav className="m-0 flex-1 flex flex-row items-start justify-between gap-[20px] text-center text-lg text-neutral-colors-headings-black font-text-single-200-bold mq800:hidden">
...
Header1.propTypes = {
  ...
  onMasterSecondaryButtonClick: PropTypes.func,
