...
const Content = ({ className = "" }) => {
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 pb-[84px] pr-0 pl-0.5 box-border max-w-full text-left text-25xl text-neutral-colors-headings-black font-text-single-200-bold mq450:pb-9 mq450:box-border mq800:pb-[55px] mq800:box-border ${className}`}
    >
      <div className="bg-grayscale-white overflow-hidden shrink-0 flex flex-row items-start justify-start max-w-full">
        <div className="ml-[-1px] w-full flex flex-row items-start justify-between py-[114px] pr-0 pl-[125px] box-border gap-[57.1px] shrink-0 [debug_commit:bf4bc93] max-w-[119%] lg:flex-wrap lg:pl-[62px] lg:box-border mq450:gap-[29px] mq450:pl-[31px] mq450:box-border mq800:pt-[74px] mq800:pb-[74px] mq800:box-border mq1125:pt-12 mq1125:pb-12 mq1125:box-border">
          <div className="h-[848px] w-full relative bg-grayscale-white hidden max-w-full" />
          ...
          <img
            className="h-[620px] flex-1 relative max-w-full overflow-hidden min-w-[695px] z-[1] lg:order-last mq1125:hidden"
            loading="lazy"
            alt=""
